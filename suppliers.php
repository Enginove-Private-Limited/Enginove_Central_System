...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; font-family:'Poppins',sans-serif; }
        ...
        .search-filter input { padding:10px 16px; border:2px solid #e5e7eb; border-radius:8px; font-size:14px; width:250px; }
        ...
        @media(max-width:768px) { .content { padding:15px; } .page-title { font-size:22px; } .actions { flex-direction:column; } .search-filter input { width:100%; } }
    </style>
</head>
<body>
<div class="wrapper">
    ...
    <div class="main">
        ...
        <div class="content">
            <h1 class="page-title"><i class="fas fa-truck"></i> <?= $pageTitle ?></h1>
            <p class="subtitle">Manage supplier database and contacts.</p>
            ...
            <div class="actions">
                <button class="btn btn-green" onclick="openModal()"><i class="fas fa-plus"></i> Add Supplier</button>
                <div class="search-filter">
                    <input type="text" id="searchInput" placeholder="Search suppliers..." onkeyup="filterTable()">
                </div>
            </div>
                ...
                <table id="supplierTable">
                    ...
                    <tbody>
                        <?php foreach ($suppliers as $s): ?>
                            <tr>
                                <td><strong><?= htmlspecialchars($s['supplier_name']) ?></strong></td>
...
<div class="modal" id="supplierModal">
    <div class="modal-content">
        ...
        <form method="POST">
            ...
            <button type="submit" class="btn btn-green" style="width:100%;justify-content:center;"><i class="fas fa-save"></i> Save Supplier</button>
        </form>
    </div>
</div>

<script>
function openModal() { document.getElementById('supplierModal').classList.add('show'); }
function closeModal() { document.getElementById('supplierModal').classList.remove('show'); }
...
window.onclick = function(e) { if (e.target === document.getElementById('supplierModal')) closeModal(); }
</script>
</body>
</html>
